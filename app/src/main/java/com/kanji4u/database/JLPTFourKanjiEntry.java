...
@Entity(tableName = "jlpt_four_kanji_entry")
public class JLPTFourKanjiEntry implements Parcelable, DBKanji {
     ...
     */
    public JLPTFourKanjiEntry(String kanjiLiteral, String JISCode, String unicode, String grade, String strokeNum, String frequencyRank, String JLPTLevel, ArrayList<String> onReadings, ArrayList<String> kunReadings, ArrayList<String> englishMeanings, boolean memorizedKanji) {
        this.kanjiLiteral = kanjiLiteral;
        this.JISCode = JISCode;
        this.unicode = unicode;
        this.grade = grade;
    ...
    public JLPTFourKanjiEntry(Parcel in){
        //get uid first
        this.uid = in.readInt();
    ...
    public static final Creator CREATOR = new Creator() {
        ...
        public JLPTFourKanjiEntry createFromParcel(Parcel in) {
            return new JLPTFourKanjiEntry(in);
        }

        public JLPTFourKanjiEntry[] newArray(int size) {
            return new JLPTFourKanjiEntry[size];
        }
    };
}
