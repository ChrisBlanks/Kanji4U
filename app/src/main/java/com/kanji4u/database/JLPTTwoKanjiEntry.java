...
@Entity(tableName = "jlpt_two_kanji_entry")
public class JLPTTwoKanjiEntry implements Parcelable, DBKanji  {
     ...
     */
    public JLPTTwoKanjiEntry(String kanjiLiteral, String JISCode, String unicode, String grade, String strokeNum, String frequencyRank, String JLPTLevel, ArrayList<String> onReadings, ArrayList<String> kunReadings, ArrayList<String> englishMeanings, boolean memorizedKanji) {
        this.kanjiLiteral = kanjiLiteral;
        this.JISCode = JISCode;
        this.unicode = unicode;
        this.grade = grade;
    ...
    public JLPTTwoKanjiEntry(Parcel in){
        //get uid first
        this.uid = in.readInt();
    ...
    public static final Creator CREATOR = new Creator() {
        ...
        public JLPTTwoKanjiEntry createFromParcel(Parcel in) {
            return new JLPTTwoKanjiEntry(in);
        }

        public JLPTTwoKanjiEntry[] newArray(int size) {
            return new JLPTTwoKanjiEntry[size];
        }
    };
}
