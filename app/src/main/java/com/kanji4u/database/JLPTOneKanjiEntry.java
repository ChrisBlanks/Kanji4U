...
@Entity(tableName = "jlpt_one_kanji_entry")
public class JLPTOneKanjiEntry implements Parcelable, DBKanji {
     ...
     */
    public JLPTOneKanjiEntry(String kanjiLiteral, String JISCode, String unicode, String grade, String strokeNum, String frequencyRank, String JLPTLevel, ArrayList<String> onReadings, ArrayList<String> kunReadings, ArrayList<String> englishMeanings, boolean memorizedKanji) {
        this.kanjiLiteral = kanjiLiteral;
        this.JISCode = JISCode;
        this.unicode = unicode;
        this.grade = grade;
    ...
    public JLPTOneKanjiEntry(Parcel in){
        //get uid first
        this.uid = in.readInt();
    ...
    public static final Creator CREATOR = new Creator() {
        ...
        public JLPTOneKanjiEntry createFromParcel(Parcel in) {
            return new JLPTOneKanjiEntry(in);
        }

        public JLPTOneKanjiEntry[] newArray(int size) {
            return new JLPTOneKanjiEntry[size];
        }
    };
}
