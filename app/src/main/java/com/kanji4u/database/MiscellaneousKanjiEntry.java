...
public class MiscellaneousKanjiEntry implements Parcelable, DBKanji  {
     ...
     */
    public MiscellaneousKanjiEntry(String kanjiLiteral, String JISCode, String unicode, String grade, String strokeNum, String frequencyRank, String JLPTLevel, ArrayList<String> onReadings, ArrayList<String> kunReadings, ArrayList<String> englishMeanings, boolean memorizedKanji) {
        this.kanjiLiteral = kanjiLiteral;
        this.JISCode = JISCode;
        this.unicode = unicode;
        this.grade = grade;
    ...
    public MiscellaneousKanjiEntry(Parcel in){
        //get uid first
        this.uid = in.readInt();
    ...
    public static final Creator CREATOR = new Creator() {
        ...
        public MiscellaneousKanjiEntry createFromParcel(Parcel in) {
            return new MiscellaneousKanjiEntry(in);
        }

        public MiscellaneousKanjiEntry[] newArray(int size) {
            return new MiscellaneousKanjiEntry[size];
        }
    };
}
